...
open class TextFieldEffects : UITextField {
    ...
    */
    ...
    override open func willMove(toSuperview newSuperview: UIView!) {
        if newSuperview != nil {
            NotificationCenter.default.addObserver(self, selector: "textFieldDidEndEditing", name:NSNotification.Name.UITextFieldTextDidEndEditing, object: self)
            
            NotificationCenter.default.addObserver(self, selector: "textFieldDidBeginEditing", name:NSNotification.Name.UITextFieldTextDidBeginEditing, object: self)
        } else {
